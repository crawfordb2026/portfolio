document.addEventListener('DOMContentLoaded', () => {
    console.log('DOM loaded, initializing star animation...');
    ...
    try {
        ...
        console.log('Stars container found, creating stars...');
        ...
        function createStars() {
            ...
            console.log(`Created ${starsCount} stars`);
        }
        ...
        console.log('Star animation initialized successfully!');
    } catch (error) {
